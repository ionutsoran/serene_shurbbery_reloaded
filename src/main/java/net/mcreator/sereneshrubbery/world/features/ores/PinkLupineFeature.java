...
//
//public class PinkLupineFeature
//extends OreFeature {
//    public static PinkLupineFeature FEATURE = null;
...
//        FEATURE = new PinkLupineFeature();
//        CONFIGURED_FEATURE = FeatureUtils.m_206488_((String)"serene_shrubbery:pink_lupine", (Feature)FEATURE, (FeatureConfiguration)new OreConfiguration((RuleTest)PinkLupineFeatureRuleTest.INSTANCE, ((Block)SereneShrubberyModBlocks.PINK_LUPINE.get()).m_49966_(), 5));
//        PLACED_FEATURE = PlacementUtils.m_206509_((String)"serene_shrubbery:pink_lupine", CONFIGURED_FEATURE, List.of(CountPlacement.m_191628_((int)30), InSquarePlacement.m_191715_(), HeightRangePlacement.m_191680_((VerticalAnchor)VerticalAnchor.m_158922_((int)0), (VerticalAnchor)VerticalAnchor.m_158922_((int)100)), BiomeFilter.m_191561_()));
//        return FEATURE;
//    }
//
...
//    private static class PinkLupineFeatureRuleTest
//    extends RuleTest {
//        static final PinkLupineFeatureRuleTest INSTANCE = new PinkLupineFeatureRuleTest();
//        private static final Codec<PinkLupineFeatureRuleTest> CODEC = Codec.unit(() -> INSTANCE);
//        private static final RuleTestType<PinkLupineFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;
//        private List<Block> base_blocks = null;
//
//        private PinkLupineFeatureRuleTest() {
//        }
//
//        @SubscribeEvent
//        public static void init(FMLCommonSetupEvent event) {
//            Registry.m_122965_((Registry)Registry.f_122861_, (ResourceLocation)new ResourceLocation("serene_shrubbery:pink_lupine_match"), CUSTOM_MATCH);
//        }
//

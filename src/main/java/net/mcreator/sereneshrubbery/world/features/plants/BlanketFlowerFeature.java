...
//
//public class BlanketFlowerFeature
//extends RandomPatchFeature {
//    public static BlanketFlowerFeature FEATURE = null;
//    public static Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> CONFIGURED_FEATURE = null;
//    public static Holder<PlacedFeature> PLACED_FEATURE = null;
//    public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("stony_shore"), new ResourceLocation("beach"), new ResourceLocation("biomesoplenty:dune_beach"), new ResourceLocation("biomesoplenty:tropics"), new ResourceLocation("byg:rainbow_beach"), new ResourceLocation("byg:dacite_shore"));
//    private final Set<ResourceKey<Level>> generate_dimensions = Set.of(Level.f_46428_);
//
//    public static Feature<?> feature() {
//        FEATURE = new BlanketFlowerFeature();
//        CONFIGURED_FEATURE = FeatureUtils.m_206488_((String)"serene_shrubbery:blanket_flower", (Feature)FEATURE, (FeatureConfiguration)FeatureUtils.m_206480_((Feature)Feature.f_65741_, (FeatureConfiguration)new SimpleBlockConfiguration((BlockStateProvider)BlockStateProvider.m_191384_((BlockState)((Block)SereneShrubberyModBlocks.BLANKET_FLOWER.get()).m_49966_())), List.of(), (int)40));
//        PLACED_FEATURE = PlacementUtils.m_206509_((String)"serene_shrubbery:blanket_flower", CONFIGURED_FEATURE, List.of(CountPlacement.m_191628_((int)5), RarityFilter.m_191900_((int)32), InSquarePlacement.m_191715_(), PlacementUtils.f_195352_, BiomeFilter.m_191561_()));
//        return FEATURE;
//    }
//

...
//
//public class PurpleLiverwortFeature
//extends RandomPatchFeature {
//    public static PurpleLiverwortFeature FEATURE = null;
...
//        FEATURE = new PurpleLiverwortFeature();
//        CONFIGURED_FEATURE = FeatureUtils.m_206488_((String)"serene_shrubbery:purple_liverwort", (Feature)FEATURE, (FeatureConfiguration)FeatureUtils.m_206480_((Feature)Feature.f_65741_, (FeatureConfiguration)new SimpleBlockConfiguration((BlockStateProvider)BlockStateProvider.m_191384_((BlockState)((Block)SereneShrubberyModBlocks.PURPLE_LIVERWORT.get()).m_49966_())), List.of(), (int)30));
//        PLACED_FEATURE = PlacementUtils.m_206509_((String)"serene_shrubbery:purple_liverwort", CONFIGURED_FEATURE, List.of(CountPlacement.m_191628_((int)6), InSquarePlacement.m_191715_(), PlacementUtils.f_195356_, BiomeFilter.m_191561_()));
//        return FEATURE;
//    }
//

...
//
//public class HydrangeaFeature
//extends RandomPatchFeature {
//    public static HydrangeaFeature FEATURE = null;
...
//        FEATURE = new HydrangeaFeature();
//        CONFIGURED_FEATURE = FeatureUtils.m_206488_((String)"serene_shrubbery:hydrangea", (Feature)FEATURE, (FeatureConfiguration)FeatureUtils.m_206480_((Feature)Feature.f_65741_, (FeatureConfiguration)new SimpleBlockConfiguration((BlockStateProvider)BlockStateProvider.m_191384_((BlockState)((Block)SereneShrubberyModBlocks.HYDRANGEA.get()).m_49966_())), List.of(), (int)14));
//        PLACED_FEATURE = PlacementUtils.m_206509_((String)"serene_shrubbery:hydrangea", CONFIGURED_FEATURE, List.of(CountPlacement.m_191628_((int)1), RarityFilter.m_191900_((int)32), InSquarePlacement.m_191715_(), PlacementUtils.f_195352_, BiomeFilter.m_191561_()));
//        return FEATURE;
//    }
//

...
//
//public class BarrelCactus2Feature
//extends OreFeature {
//    public static BarrelCactus2Feature FEATURE = null;
...
//        FEATURE = new BarrelCactus2Feature();
//        CONFIGURED_FEATURE = FeatureUtils.m_206488_((String)"serene_shrubbery:barrel_cactus_2", (Feature)FEATURE, (FeatureConfiguration)new OreConfiguration((RuleTest)BarrelCactus2FeatureRuleTest.INSTANCE, ((Block)SereneShrubberyModBlocks.BARREL_CACTUS_2.get()).m_49966_(), 5));
//        PLACED_FEATURE = PlacementUtils.m_206509_((String)"serene_shrubbery:barrel_cactus_2", CONFIGURED_FEATURE, List.of(CountPlacement.m_191628_((int)30), InSquarePlacement.m_191715_(), HeightRangePlacement.m_191680_((VerticalAnchor)VerticalAnchor.m_158922_((int)0), (VerticalAnchor)VerticalAnchor.m_158922_((int)100)), BiomeFilter.m_191561_()));
//        return FEATURE;
//    }
//
...
//    private static class BarrelCactus2FeatureRuleTest
//    extends RuleTest {
//        static final BarrelCactus2FeatureRuleTest INSTANCE = new BarrelCactus2FeatureRuleTest();
//        private static final Codec<BarrelCactus2FeatureRuleTest> CODEC = Codec.unit(() -> INSTANCE);
//        private static final RuleTestType<BarrelCactus2FeatureRuleTest> CUSTOM_MATCH = () -> CODEC;
//        private List<Block> base_blocks = null;
//
//        private BarrelCactus2FeatureRuleTest() {
//        }
//
//        @SubscribeEvent
//        public static void init(FMLCommonSetupEvent event) {
//            Registry.m_122965_((Registry)Registry.f_122861_, (ResourceLocation)new ResourceLocation("serene_shrubbery:barrel_cactus_2_match"), CUSTOM_MATCH);
//        }
//
//        public boolean m_7715_(BlockState blockAt, Random random) {
//            if (this.base_blocks == null) {
//                this.base_blocks = List.of(Blocks.f_50036_, Blocks.f_50034_, (Block)SereneShrubberyModBlocks.BARREL_CACTUSS_1.get());
//            }
